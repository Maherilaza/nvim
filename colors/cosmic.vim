...
let s:base01 = ['#3ff5f00', '237']
let s:base02 = ['#004052', '237']
let s:base03 = ['#005a6f', '238']
let s:base04 = ['#d0d0d0', '252']
let s:base05 = ['#3f6b3a', '187'] " type
let s:base06 = ['#fdf6e3', '230']
let s:base07 = ['#87ffff', '123']
let s:base08 = ['#ff5f00', '75']
let s:base09 = ['#caceca', '81']
let s:base10 = ['#caceca', '14']
let s:base11 = ['#3f6b3a', '49']
let s:base12 = ['#afffaf', '157']
let s:base13 = ['#caceca', '190']
let s:base14 = ['#ff5f00', '202']
let s:base15 = ['#e0596b', '198']
"}}}
" Highlight function "{{{
" ----------------------------------------------------------------------
